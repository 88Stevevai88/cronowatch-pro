...
def main():
    ...
    st.markdown("<h1 style='color:#00AEEF;'>CronoWatch Pro</h1><p>Monitoraggio automatico WCRO + Token Analysis</p>", unsafe_allow_html=True)
    ...
    tab1, tab2, tab3 = st.tabs(["📊 Dashboard", "📆 Storico Mensile", "🎯 Token Tracker"])
